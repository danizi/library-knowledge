...
| Navigation vs 手写 FM | `FG-001,10` | D8 | Demo+卡；待默答 F13 |
| ViewPager2 + `FragmentStateAdapter` | `FG-001,11` | D9 | Demo+卡；待默答 F14 |
...
**D8 验收**：`[x]` Demo（2026-09-05）`[x]` FG-001,10 落盘（2026-09-05）`[x]` 默答 F13（2026-09-05）
...
**D9 验收**：`[x]` Demo（2026-09-05）`[x]` FG-001,11 落盘（2026-09-05）`[x]` 默答 F14（2026-09-05）
...
**D10 验收**：`[x]` F1–F14 口述 ≥11/14（2026-09-06）`[x]` 错题库无未订正开口题（2026-09-06）
...
**现在进行到**：FG **D0–D10 已收口**。要复盘说「默答 F题号」或「教我 ACT …」；转场动画选做。
